/*
 * @Author: Diana Tang
 * @Date: 2024-10-29 20:49:23
 * @LastEditors: Diana Tang
 * @Description: 一款免费的开源性能监控SDK,目前能够完成监控的指标包含FCP等
 * @FilePath: /DT-performance-monitor-SDK/src/index.ts
 */
...
export default class DianaTang {
    private v = '1.0.0';
    private reportData: IReportData;
    constructor(options: IDianaTangOptions = {}) {
      // 扩展基础配置
      const logUrl = options.logUrl;
      if (!logUrl) {
        throw new Error(`DT系统监控平台${this.v}提示未传递logUrl`);
      }
      //向后台输送数据
