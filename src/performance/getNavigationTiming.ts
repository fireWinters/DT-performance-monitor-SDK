 ...
 * @FilePath: /DT-performance-monitor-SDK/src/performance/getNavigationTiming.ts
 */
import { WP } from '../data/constants';
import { isPerformanceSupported } from '../helpers/isSupported';
import { IDianaTangNavigationTiming } from '../typings/types';
 ...
 */
export const getNavigationTiming = (): IDianaTangNavigationTiming => {
